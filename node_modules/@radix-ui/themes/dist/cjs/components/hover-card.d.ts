...
interface HoverCardTriggerProps extends Omit<React.ComponentPropsWithoutRef<typeof HoverCardPrimitive.Trigger>, 'asChild'> {
}
...
interface HoverCardContentProps extends Omit<React.ComponentPropsWithoutRef<typeof HoverCardPrimitive.Content>, 'asChild'>, HoverCardContentOwnProps {
...
declare const HoverCard: {
    Root: React.FC<HoverCardRootProps>;
