...
declare const AlertDialogRoot: React.FC<AlertDialogProps>;
interface AlertDialogTriggerProps extends Omit<React.ComponentPropsWithoutRef<typeof AlertDialogPrimitive.Trigger>, 'asChild'> {
}
...
interface AlertDialogContentProps extends Omit<React.ComponentPropsWithoutRef<typeof AlertDialogPrimitive.Content>, 'asChild'>, AlertDialogContentOwnProps {
...
interface AlertDialogActionProps extends Omit<React.ComponentPropsWithoutRef<typeof AlertDialogPrimitive.Action>, 'asChild'> {
}
...
interface AlertDialogCancelProps extends Omit<React.ComponentPropsWithoutRef<typeof AlertDialogPrimitive.Cancel>, 'asChild'> {
}
...
declare const AlertDialog: {
    Root: React.FC<AlertDialogProps>;
